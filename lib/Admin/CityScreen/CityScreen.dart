                      ...
                      Obx(() {
                        return Column(
                          children: controller.keywordCategories.map((item) {
                            ...
                            final bool shouldHighlight = (item['category'] ?? '').toLowerCase() == 'australia' ||
                                (item['states'] ?? '').toLowerCase() == 'lombardy' ||
                                (item['city'] ?? '').toLowerCase() == 'L’Aquila';
